...
/**
 * Generates a lorentz transformation representing a hyperbolic "rotation" in the plane defined by axes whose indices are `a` and `b`.
 * @param a index of the first axis in the plane of rotation
 * @param b index of the second axis in the plane of rotation
 * @param v Rapidity or "angle" of the "rotation"
